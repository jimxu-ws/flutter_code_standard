...
class UserDetailAsyncScreen extends ConsumerWidget {
  const UserDetailAsyncScreen({required this.userId, super.key});
...
class AsyncUserInfoCard extends StatelessWidget {
  const AsyncUserInfoCard({required this.user, super.key});
...
class AsyncPostCard extends StatelessWidget {
  const AsyncPostCard({required this.post, required this.index, super.key});
...
class AsyncErrorCard extends StatelessWidget {
  const AsyncErrorCard({required this.error, super.key, this.onRetry});

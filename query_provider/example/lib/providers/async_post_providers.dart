...
final asyncPostsInfiniteQueryProvider =
    asyncInfiniteQueryProvider<PostPage, int>(
...
final asyncPostsInfiniteQueryProviderNoKeepPrevious =
    asyncInfiniteQueryProvider<PostPage, int>(
  ...
  options: InfiniteQueryOptions<PostPage, int>(
    ...
    staleTime: const Duration(
        seconds: 5), // Short stale time to demonstrate the difference
    cacheTime: const Duration(minutes: 10),
    // refetchOnAppFocus: true,
    refetchOnWindowFocus: true,
    pauseRefetchInBackground: true,
